...
#[metrics(prefix = "sequencer_proof_client")]
pub struct SequencerProofClientMetrics {}

pub(crate) static SEQUENCER_PROOF_CLIENT_METRICS: vise::Global<SequencerProofClientMetrics> =
    vise::Global::new();
